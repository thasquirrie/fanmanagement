...
exports.protect = catchAsync(async (req, res, next) => {
 ...
 if (!token)
  return next(
   new AppError('You are not logged in! Please login to access this route', 400)
  );
 ...
 if (!checked) return next(new AppError('Password changed after token was issued. Please log in again!', 404));

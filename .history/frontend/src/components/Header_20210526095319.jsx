 ...
 render() {
  ...
  return (
   <nav className='bg-black w-full sm:flex sm:justify-between'>
    ...
    <div
     className={`${showClass} px-3 pt-2 pb-4 sm:flex sm:justify-end sm:ml-3 sm:mr-3 sm:p-3`}
    >
     <NavLink
     ...
     <NavLink
      className='bg-red-700 block py-2 px-3 mt-1 rounded hover:bg-red-400 text-white font-semibold'
      to='/start'
     >
      Get Started
     </NavLink>

...
const Header = () => {
 ...
 return (
  <nav className='bg-black w-full'>
   ...
   <div>
    <NavLink className='block text-md text-white font-semibold' to='/about'>
     About us
    </NavLink>
    <NavLink className='block text-md text-white font-semibold' to='/faq'>
     FAQ
    </NavLink>
    <NavLink className='block text-md text-white font-semibold' to='/start'>
     Get Started
    </NavLink>
   </div>
  </nav>

 ...
 render() {
  ...
  return (
   <nav className='bg-black sm:flex sm:justify-between'>
    ...
    >
     <NavLink
      className='block py-2 px-3 mt-1 sm:ml-3 rounded hover:bg-gray-400 text-white font-semibold'
      to='/about'
     >
      About us
     </NavLink>
     ...
     <NavLink
      className='bg-red-700 block py-2 px-3 mt-1 sm:ml-3 rounded hover:bg-red-400 text-white font-semibold w-full text-center'
      to='/start'
     >
      Get Started
     </NavLink>

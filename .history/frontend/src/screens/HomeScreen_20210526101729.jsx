 ...
 return (
  <>
   ...
   <div className='mt-4 bg-green-50'>
    <h2 className=' sm:bg-black text-xl text-center text-transparent bg-clip-text bg-black'>
     Membership Details
    </h2>
    <h2 className='sm:bg-black text-xl text-center text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-white to-red-700'>
     Membership Details
    </h2>
    <h2 className='sm:bg-black text-xl text-center text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-white to-red-700'>
     Membership Details

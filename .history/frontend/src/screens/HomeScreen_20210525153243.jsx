...
const HomeScreen = () => {
 return (
  <>
   <div className='flex'>
    <div className='px-8 py-12 max-w-md mx-auto lg:w-1/2 lg:max-w-full lg:py-48 lg:px-12 lg:align-baseline'>
     ...
     />
     <h1 className='mt-6 text-2xl font-bold text-gray-900 leading-tight lg:text-4xl xl:ml-auto'>

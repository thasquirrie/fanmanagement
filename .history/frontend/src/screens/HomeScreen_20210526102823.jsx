...
const HomeScreen = () => {
 return (
  <>
   ...
   <div className='bg-gradient-to-br from-green-400 via-white to-blue-500'>
    {/* <div class='text-5xl font-extrabold text-center'>
     <span class='bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500'>
      Hello world
     </span>
    </div> */}
    <h2 className='mt-4 text-5xl font-extrabold text-center bg-clip-text text-transparent  bg-gradient-to-r from-yellow-400 to-red-700'>
     Membership Details
    </h2>
    <h4 className='text-center text-gray-700 text-lg font-semibold py-3'>

 ...
 return (
  <>
   ...
   <div className='mt-4 bg-green-50'>
    <h2 className='inline-block w-full mx-auto sm:bg-black text-xl text-center bg-gradient-to-r from-yellow-400 via-white to-red-700'>
     Membership Details
    </h2>
    <h2 className='sm:bg-black text-xl text-center bg-gradient-to-r from-yellow-400 via-white to-red-700'>
     Membership Details
    </h2>
    <h2 className='sm:bg-black text-xl text-center bg-gradient-to-r from-yellow-400 via-white to-red-700'>
     Membership Details

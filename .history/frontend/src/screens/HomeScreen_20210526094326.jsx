...
const HomeScreen = () => {
 return (
  <>
   <div className='flex lg:justify-end bg-gradient-to-r from-yellow-400 via-white to-red-700'>
    ...
    <div className='hidden lg:block lg:w-1/2 relative'>
     <div className='flex'>
      ...
      />
      <img
       className='absolute inset-yt-96 inset-x-60 object-contain object-center'
       src='/img/Media.png'
       alt='Woman organizing'
      />
     </div>

 ...
 return (
  <>
   <div className='bg-gray-100 flex'>
    ...
    <div className='hidden bg-gray-100 lg:block lg:w-1/2 relative'>
     <img
      className='mt-6 rounded-lg sm:mt-8 sm:w-full absolute inset-0 h-full w-full object-cover object-center'
      src='/img/Communication.png'
      alt='Woman organizing'
     />
    </div>

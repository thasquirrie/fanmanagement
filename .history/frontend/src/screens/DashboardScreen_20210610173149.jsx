...
let buttonClasses =
 'inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 disabled:opacity-50';
...
const navigation = [
 ...
 { name: 'Contact Us', href: '#', icon: UserGroupIcon, current: false },
       ...
       <div className='px-4 sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8'>
        <div className='py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200'>
           ...
           <div>
            <div className='flex items-center'>
             ...
             <h1 className='ml-3 text-2xl font-bold leading-7 text-gray-900 sm:leading-9 sm:truncate'>
              Good morning, {userInfo.user.name}
             </h1>
            </div>
         ...
         >
          ...
          <button disabled={userInfo.user.verified} className={buttonClasses}>
           <Link disabled={true} to='/pricing' className='disabled:opacity-50'>
            Verify Membership
           </Link>
          </button>
         </div>

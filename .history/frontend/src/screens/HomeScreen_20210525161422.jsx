...
const HomeScreen = () => {
 return (
  <>
   <div className='flex'>
    <div className='px-8 py-12 max-w-md mx-auto sm:max-w-full sm:mx-auto lg:w-1/2 lg:max-w-full lg:py-28 lg:px-12 lg:align-baseline'>
     <img className='h-14' src='/img/pngegg.png' alt='Big Machine' />
     <img
     ...
     <div className='mt-4'>
      <button className='inline-block px-5 py-3 rounded-lg bg-red-700 text-white uppercase tracking-wider shadow-lg font-semibold lg:text-xl hover:bg-red-600 focus:outline-none focus:shadow-outline'>
       Get Started
      </button>
     </div>
    </div>
    <div className='hidden lg:block lg:w-1/2 relative'>
     <div className='flex'>
      <img
       className='absolute inset-0 object-cover object-center 2xl:w-full'
       src='/img/Communication.png'
       alt='Woman organizing'
      />
      <img

    ...
    <div>
     <div className='flex px-8 justify-between'>
      <div className='w-1/3 m-3'>
       <button className='bg-red-500 py-8 w-full text-white active:bg-red-700'>
        Standard
       </button>
      </div>
      <div className='w-1/3 m-3'>
     ...
     <div className=''>
      <div>
       <span className='text-center w-full inline-block'>Subscription</span>
       <div className='flex px-8 justify-between'>
        <div className='w-1/3'>
         <p className='py-4 w-full text-gray-700 items-center text-center'>
          $500
         </p>
        </div>
        <div className='w-1/3'>

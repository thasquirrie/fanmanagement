   ...
   <main>
    ...
    <div className='relative'>
     ...
     <div className='relative max-w-2xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8'>
      <div className='relative py-24 px-8 bg-gradient-to-r from-teal-500 to cyan-600 rounded-xl shadow-2xl overflow-hidden lg:px-16 lg:grid lg:grid-cols-2 lg:gap-x-8'>
       ...
       <div className='relative lg:col-span-1'>
        ...
        <blockquote className='mt-6 text-white'>
         <p className='text-xl font-medium sm:text-2xl'>
          Workflow has completely transformed how we interact with customers.
          We've seen record bookings, higher customer satisfaction, and reduced
          churn.
         </p>
